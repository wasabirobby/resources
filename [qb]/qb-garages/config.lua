...
Config.Garages = {
    ["motelgarage"] = {
        ["label"] = "Unity station 2",
        ["takeVehicle"] = vector3(1770.94, -1865.72, 13.06),
        ["spawnPoint"] = vector4(1770.34, -1859.05, 12.89, 331.89),
        ["putVehicle"] = vector3(1798.92, -1863.88, 13.06),
        ["showBlip"] = true,
    ...
    ["pillboxgarage"] = {
        ["label"] = "San Fierro Hotel Parking ",
        ["takeVehicle"] =  vector3(-1729.87, 991.48, 16.87),
        ["spawnPoint"] = vector4(-1736.65, 1016.86, 16.87, 270.6),
        ["putVehicle"] = vector3(-1721.03, 1016.59, 17.12),
        ["showBlip"] = true,
        ["blipName"] = "Public Parking",
        ["blipNumber"] = 357,
        ["blipColor"] = 3,
