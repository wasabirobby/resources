...
Config.Zones = {
      --[[ [1] = {
        position = vector3(-1517.42, 2645.34, 55.85),-- Robada gas station ATM
        length = 6.2, width = 2.0, heading = 250,
        minZ = 27.17, maxZ = 31.17
    },
    [2] = {
        position = vector3(-1920.17, 1144.87, 46.27),
...
Config.BankLocations = {
    vector3(1335.09, -980.26, 33.91),--LS CHASE 
    vector3(-1909.95, 1144.48, 46.27),--SF Pacific
    vector3(-1908.4, 1144.48, 46.27),--SF Pacific
    vector3(-1920.17, 1144.87, 46.27),--SF Pacific
    vector3(-1914.16, 1145.47, 46.27),--SF Pacific
    vector3(-1910.14, 1145.0, 46.27),-- SF Pacific
    vector3(2316.59, -10.13, 26.75),-- Palomino creek
