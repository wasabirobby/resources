...
local function updateBlip()
    if PlayerData.job.name == "busls" then
            ...
            CreateThread(function()
                repeat
                    ...
                    if IsControlJustPressed(0, 38) then
                        ...
                        resetNpcTask()
                        nextStop()
                        TriggerEvent('qb-busjob2:client:DoBusNpc')
...
local function busGarage()
    ...
    for _, v in pairs(Config.AllowedVehicles) do
        vehicleMenu[#vehicleMenu + 1] = {
            header = v.label,
            params = {
                event = "qb-busjob2:client:TakeVehicle",
                args = {
                    model = v.model
                }
            }
...
RegisterNetEvent("qb-busjob2:client:TakeVehicle", function(data)
    ...
    if (BusData.Active) then
        ...
        QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
            ...
            exports['LegacyFuel']:SetFuel(veh, 85.0)
            closeMenuFull()
...
RegisterNetEvent('qb-busjob2:client:DoBusNpc', function()
                    ...
                    CreateThread(function()
                        repeat
                            ...
                            if IsControlJustPressed(0, 38) then
                                ...
                                TriggerServerEvent('qb-busjob2:server:NpcPay')
                                exports["qb-core"]:HideText()
                                PolyZone:destroy()
                                break
                            end
