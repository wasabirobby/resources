...
Config.GrantWeaponLicenses = {
    enabled = true, -- If you want police to have option to grant weapons licenses
...
Config.Locations = {
    LSPD = {
        blip = {
            enabled = true,
            coords = vec3(1539.81, -1668.43, 13.55),
            sprite = 60,
            color = 29,
            scale = 1.0,
            string = 'Pershing Square San Andreas Police Department'
        },
--,vector3(-449.811, 6012.909, 31.815)}
        clockInAndOut = {
            ...
            coords = vec3(1587.61, -1676.29, 13.11), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vec3(1587.61, -1676.29, 13.11),
                heading = 91.06,
                width = 2.0,
                length = 1.0,
                minZ = 30.69-0.9,
        ...
        bossMenu = {
            ...
            coords = vector3(1577.05, -1675.51, 13.12), -- Location of boss menu (If not using target)
            ...
            target = {
                ...
                coords = vector3(1566.92, -1695.52, 13.12),
                heading = 269.85,
                width = 2.0,
                length = 1.0,
                minZ = 30.73-0.9,
        ...
        armoury = {
            ...
            coords = vec3(1585.56, -1666.63, 12.12), -- Coords of armoury
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
        ...
        cloakroom = {
            ...
            jobLock = 'police', -- Allow only one of Config.policeJob listings / Set to false if allow all Config.policeJobs
            coords = vec3(1582.06, -1678.59, 13.12), -- Coords of cloakroom
    ...
    TRSD = {
        blip = {
            ...
            color = 29,
            scale = 1.0,
            string = 'Tierra Robada Sheriffs department'
        },
