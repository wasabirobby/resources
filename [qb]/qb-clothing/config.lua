...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1099.08, -1504.76, 15.76), width = 2, length = 2}, -- Verona mall
...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(1578.39, -1675.59, 13.12), width = 2, length = 2, cameraLocation = vector4(1581.13, -1675.81, 13.12, 89.21)},--LSPD Pershing   
