...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(1663.69, -1384.02, 13.6),-- pillbox
	    [2] = vector3(1661.33, -1379.75, 13.6), -- pillbox
    },
    ["duty"] = {
        [1] = vector3(1650.74, -1355.2, 13.6),--pillbox
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(1658.47, -1425.2, 13.57, 112.39),--pillbox
    ...
    ["armory"] = {
        [1] = vector3(1671.65, -1381.47, 13.6),--pillbox
        [2] = vector3(1667.7, -1383.86, 13.6), --pillbox
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(1650.02, -1355.13, 13.6),--pillbox
    },
    ["stash"] = {
        [1] = vector3(1670.8, -1387.02, 13.6),--pillbox
        [2] = vector3(1671.05, -1389.92, 13.6),--pillbox
    },
    ["beds"] = {
        --Pillbox WARD A Intense care
        [1] = {coords = vector4(1652.53, -1376.77, 14.52, 265.35), taken = false, model = 1631638868},
        [2] = {coords = vector4(1652.1, -1379.98, 14.53, 267.55), taken = false, model = 1631638868},
        [3] = {coords = vector4(1652.39, -1383.67, 14.52, 109.77), taken = false, model = 2117668672},
        [4] = {coords = vector4(1647.88, -1382.61, 14.53, 89.94), taken = false, model = 2117668672},
        [5] = {coords = vector4(1648.2, -1376.62, 14.54, 96.66), taken = false, model = 2117668672},
        [6] = {coords = vector4(1648.16, -1371.3, 14.54, 93.29), taken = false, model = -1091386327},
        [7] = {coords = vector4(1647.88, -1387.28, 14.52, 78.11), taken = false, model = -1091386327},
        [8] = {coords = vector4(1652.33, -1387.21, 14.53, 262.51), taken = false, model = -1091386327},
	--- paleto
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(1661.15, -1388.75, 13.6, 81.34)}--pillbox
    }
}
